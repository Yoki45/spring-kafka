...
import com.kafka.libraryconsumer.repository.LibraryEventRepository;
...
public class LibraryEventServiceImpl implements ILibraryEventService {
    ...
    private void validate(LibraryEvent libraryEvent) {
        ...
        Optional<LibraryEvent> libraryEventOptional = libraryEventsRepository.findById(Long.valueOf(libraryEvent.getLibraryEventId()));
